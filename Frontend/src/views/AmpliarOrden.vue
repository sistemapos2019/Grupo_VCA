          ...
          <v-form>
            <v-container>
              <v-row>
                ...
                <v-col cols="5">
                  <v-text-field disabled v-model="detalle.mesero" label="Mesero:" required></v-text-field>
                </v-col>
                <v-col cols="5">
                  <v-text-field disabled v-model="detalle.cliente" label="Cliente:" required></v-text-field>
                </v-col>
                <v-col cols="3">
                  <v-autocomplete disabled v-model="detalle.mesa" label="Mesa" :items="mesas"  item-text="mesa" item-value="id"></v-autocomplete>
                </v-col>
                <v-col cols="7">
                  <v-text-field disabled label="Seleccione un Producto" v-model="search"></v-text-field>
                </v-col>
              </v-row>
            </v-container>
          </v-form>
